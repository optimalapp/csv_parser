...
RSpec.describe CsvParser, type: :service do
  ...
  it 'gets data from urls' do
    ...
    results = [{ store_name: 'Google', id_in_store: 'com.netease.l10' },
               ...
               { store_name: 'iOs', id_in_store: '1253537199' },
               { store_name: 'iOs', id_in_store: '1448712419' },
               { store_name: 'iOs', id_in_store: '1449235979' },
               { store_name: 'iOs', id_in_store: '1448852425' },
               { store_name: 'iOs', id_in_store: '389801252' },
               { store_name: 'iOs', id_in_store: '1445450568' },
               ...
               { store_name: 'iOs', id_in_store: '1261357853' },
               { store_name: 'iOs', id_in_store: '1089225191' },
